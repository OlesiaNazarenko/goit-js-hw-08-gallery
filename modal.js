...
const slide = document.querySelector('.lightbox__content');
...
//     evt.preventDefault();
//     if (evt.target.classList.contains('lightbox__overlay') && evt.key === 'ArrowRight') {
//         galleryItems.forEach((item, index) => { index >= item.length && (index != 0); index++ })
//     }
